          ...
          <div className={`space-y-6 transition-all duration-1000 delay-300 ${
            ...
            <div className="glass p-8 rounded-2xl">
              ...
              <p className="text-foreground/80 leading-relaxed mb-4">
                Currently pursuing B.E. in Information Technology (Hons. in Cybersecurity) at Fr. C. Rodrigues Institute of Technology. 
                I'm skilled in GRC, vulnerability assessment, and incident response, with experience in secure full-stack development.
              </p>
