  ...
  return (
    <section id="hero" className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        {floatingElements}
        {/* Larger animated orbs with better gradients */}
        <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-purple-500/10 rounded-full blur-3xl animate-pulse floating-animation"></div>
        <div className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-blue-500/10 rounded-full blur-3xl animate-pulse floating-animation" style={{ animationDelay: '2s' }}></div>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-pink-500/10 rounded-full blur-3xl animate-pulse floating-animation" style={{ animationDelay: '4s' }}></div>
        
        {/* Animated geometric shapes */}
        <div className="absolute top-20 right-20 w-6 h-6 bg-gradient-to-r from-purple-400 to-blue-500 rotate-45 animate-spin" style={{ animationDuration: '8s' }}></div>
        <div className="absolute bottom-20 left-20 w-8 h-8 bg-gradient-to-r from-blue-400 to-purple-500 rounded-full animate-bounce" style={{ animationDelay: '1s' }}></div>
      </div>
      ...
      <div className="container mx-auto px-6 text-center relative z-10">
        <div className={`transition-all duration-1000 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          ...
          <h1 className="text-6xl md:text-8xl font-bold mb-4 animate-slide-down">
            <span className="gradient-text">Aishwarya Iyer</span>
          </h1>
          ...
          <div className="flex justify-center space-x-6 animate-fade-in" style={{ animationDelay: '2s' }}>
            <a
              ...
              className="p-3 glass rounded-full hover:scale-110 transition-all duration-300 hover-glow group floating-animation"
            >
